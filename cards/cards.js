...
const BUFFS = [
  ...
  { id: 'aura',             name: 'Aura',                       desc: 'Todos os mobs ficam paralisados com medo',              icon: '✨', img: 'icons/aura.png',       type: 'buff', accent: '#eeffa5' },
  ...
  { id: 'coquetel',         name: 'Coquetel',                  desc: 'Uma bebida diferenciada',              icon: '🍹', img: 'icons/coquetel.png',       type: 'buff', accent: '#7fff65' }
